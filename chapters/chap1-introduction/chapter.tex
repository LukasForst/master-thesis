...
\begin{itemize}
    ...
    \item Design of Fides, a generic trust model fine-tuned for sharing threat intelligence in global adversarial peer-to-peer networks.~(\ref{sec:general-overview-of-fides})
    ...
    \item An evaluation of Fides in different environments and analysis of its behavior in unfavorable situations.~(\ref{ch:results})
\end{itemize}
...
\begin{itemize}
    ...
    \item Design of Fides, a generic trust model fine-tuned for sharing threat intelligence in global peer-to-peer networks.~(\ref{sec:general-overview-of-fides})

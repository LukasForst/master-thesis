...
One option is to introduce restriction to Fides, where it uses data at most from the 75\% of peers that are not pre-trusted and the rest, 25\% comes from the pre-trusted peers and organizations.

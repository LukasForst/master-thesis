...
Fides was implemented and evaluated by simulating thousands of scenarios to find the best trust model parameters for each of them. We found that Fides the new concept of pre-trusted Organisations in Fides 

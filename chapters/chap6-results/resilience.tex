...
In this scenario, Fides talks to 25\% of pre-trusted peers with. We simulated environments starting with the 75\% of confident correct peers~(behavior in Section~\ref{subsubsec:confident-correct-peer}) up to 75\% malicious peers~(behavior f

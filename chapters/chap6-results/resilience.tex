...
Because the previous performance of all methods is similar, we recommend using this combination to ensure the best performance even in the harder situations.

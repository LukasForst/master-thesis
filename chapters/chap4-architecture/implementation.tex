...
We wrote around $6058$ lines of code in total where Fides itself accounts for $2691$ lines. The rest of the implementation is related to the unit tests, simulation framework and the simulations.

...
Moreover, intelligent malicious peer knows, that it is in their incentive to gain the service trust at the beginning in order to influence the decisions of the trust model in the later stages. We simulate this by introducing a grace period when the malicious peer does not lie, but rather behaves like 

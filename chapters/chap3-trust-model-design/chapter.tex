...
First, we start with \textit{the cold start problem} in the Subsection~\ref{sec:cold-start-problem}, which describes how peers can gain trust when they are new in the network and how Fides tackles this issue.

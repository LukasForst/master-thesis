...
However, we did not introduce any of these measures to our system, and we leave that as part of future work (\ref{sec:future-work}) in Section~\ref{subsec:possible-mittigation-of-sybil-attack}. 